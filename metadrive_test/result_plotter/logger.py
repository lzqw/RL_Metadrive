...
import json, time
import numpy as np
from result_plotter import log_utils as lu
...
class SafeLogger():
    def __init__(self, log_dir="./logs", exp_name=None, env_name=None, seed=0, config=None, filename="logger.csv",
                 fieldnames=[], debug=False):
        self.exp_name = exp_name
        self.env_name = env_name
        self.seed = seed
        self.previous_log_time = time.time()
